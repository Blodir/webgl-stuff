...
export type V2Mutable = [number, number];
export type V3 = readonly [number, number, number];
export type V3Mutable = [number, number, number];
export type V4 = readonly [number, number, number, number];
export type V4Mutable = [number, number, number, number];
